...
/**
 * Simple GUI for monitoring events and state changes of an <code>Engine</code>.  Used for debugging and testing
 * purposes.
 */
public class EngineMonitor {
     ...
     *
     * @return the panel containing the labels for representing the current engine state.
     */
    ...
    /**
     * Returns a <code>String</code> representing the <code>state</code>.
     *
